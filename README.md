# map-locator-with-service-layer
...
To use arcgis-webpack-plugin instead of esri-loader to load the ArcGIS API for JavaScript modules, check out the [`@arcgis-webpack-angular`](https://github.com/Esri/map-locator-with-service-layer/tree/arcgis-webpack-angular) branch of this repo.
...
```bash
  git clone https://github.com/andygup/map-locator-with-service-layer.git
```

### Install dependencies

```bash
  cd map-locator-with-service-layer
  npm install
```
